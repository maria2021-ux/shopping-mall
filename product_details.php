...
// Fetch suggested products (for simplicity, we'll use random products)
$suggested_sql = "SELECT * FROM products WHERE id != $product_id ORDER BY RAND() LIMIT 2";
...
<div class="product-details">
    ...
    <div class="product-images">
        ...
        <div class="thumbnail-container">
            <img src="uploads/<?php echo htmlspecialchars($product['image']); ?>" alt="Image 1" class="thumbnail" onclick="changeMainImage('uploads/<?php echo htmlspecialchars($product['image']); ?>')">
            <img src="uploads/<?php echo htmlspecialchars($product['image2']); ?>" alt="Image 2" class="thumbnail" onclick="changeMainImage('uploads/<?php echo htmlspecialchars($product['image2']); ?>')">
            <img src="uploads/<?php echo htmlspecialchars($product['image3']); ?>" alt="Image 3" class="thumbnail" onclick="changeMainImage('uploads/<?php echo htmlspecialchars($product['image3']); ?>')">
        </div>

        <div class="main-image-container">
            <img id="mainImage" src="uploads/<?php echo htmlspecialchars($product['image']); ?>" alt="Main Image" class="main-image">
        </div>
    </div>
...
<div class="suggested-products">
    ...
    if ($suggested_result->num_rows > 0) {
        while($suggested = $suggested_result->fetch_assoc()) {
            ...
            echo '<img src="uploads/' . htmlspecialchars($suggested['image']) . '" alt="Suggested Product Image">';
            echo '<div class="details">';
            echo '<h3>' . htmlspecialchars($suggested['name']) . '</h3>';
            echo '<p>Price: ₩' . htmlspecialchars($suggested['price']) . '</p>';
            echo '<a href="product_details.php?id=' . $suggested['id'] . '">See More</a>';
            echo '</div>';
            echo '</div>';
        }
    } else {
